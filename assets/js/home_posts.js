                   ...
                   <div class = 'post-action'>
                       <div>
                            ...
                            <span>
                               ...
                               ${post.likes.length} <img src="https://img.icons8.com/fluent/26/000000/good-quality.png"/>
                               </a>
                            <span>
                       </div>
                   </div>
    ...
    let handlePostImage = function(){
        ...
        uploadBtn.addEventListener('change',function(){
            if(uploadBtn.value){
                ...
                document.getElementById('uploaded-file-responce').innerText = 'File added successfully';
            }
        });
    }
